    ...
    private class CheckLoginAST extends AsyncTask<String, Void, String>{
        ...
        protected void onPostExecute(String s) {
            ...
            if(s.contains("clear")){
                ...
                Toast.makeText(LoginScreen.this, "username and password incorrect", Toast.LENGTH_SHORT).show();
                username.setError("INCORRECT");
                password.setError("INCORRECT");
            } else {
                Toast.makeText(LoginScreen.this, "something went wrong! Please try again later\n" + s, Toast.LENGTH_SHORT).show();
            }
        }
    }
}
